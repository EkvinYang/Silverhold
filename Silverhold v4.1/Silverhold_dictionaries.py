...
enemyDict = {
    "sailboat": {
        "resolution": (200, 200),
        # STATS
        "Size": 5, "Health": 300, "Speed": 3, "Range": 300, "approachRange": 200,
        # ATTACK
        "Damage": 10, "attackSpeed": 20, "attackType": "cannonball",
        # MISC
        "Value": 200, "imageFile": "enemy_sailboat.png"},

    "caravel": {
        "resolution": (225, 225),
        # STATS
        "Size": 10, "Health": 750, "Speed": 2, "Range": 400, "approachRange": 250,
        # ATTACK
        "Damage": 25, "attackSpeed": 35, "attackType": "cannonball",
        # MISC
        "Value": 350, "imageFile": "enemy_caravel.png"},

    "brigantine": {
        "resolution": (300, 300),
        # STATS
        "Size": 25, "Health": 2250, "Speed": 1, "Range": 500, "approachRange": 350,
        # ATTACK
        "Damage": 75, "attackSpeed": 100, "attackType": "explosive",
        # MISC
        "Value": 1250, "imageFile": "enemy_brigantine.png"},
    }
